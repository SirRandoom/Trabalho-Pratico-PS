...
Compilando e Executando o Programa:
	Inicialmente deve-se extrair os arquivos enviados em zip para um diretório a ser utilizado. Para compilar basta abrir um terminal apontando para o diretório em que os arquivos foram extraídos e utilizar o comando make junto ao makefile(GNUmakefile) enviado com os módulos, executando a main (./main) após o termino da compilação para  iniciar o programa.
...
----Relatório de testes---------
	   test_report.txt (output do CUnit)
	   sobre_testes.txt (Comentário dos autores sobre os critérios de teste)
	   main_teste.c.gcov (Gerado pelo gcov)
-------------------------------	   
